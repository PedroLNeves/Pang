...
export class Level003 extends Phaser.Scene {
    ...
    create() {
        ...
        this.physics.add.collider(this.laserGroup, this.meteorsX, this.laserHitMeteorsX, null, this);
        this.physics.add.collider(this.laserGroup, this.meteorsY, this.laserHitMeteorsY, null, this);
        this.physics.add.collider(this.player, this.meteorsX, this.PlayerHitMeteors, null, this);
        this.physics.add.collider(this.player, this.meteorsY, this.PlayerHitMeteors, null, this);
    ...
    laserHitMeteorsY (laserGroup, meteorsY)
    {
        ...
        this.physics.add.collider(this.laserGroup, this.meteorsY1, this.laserHitMeteorsY1, null, this);
        this.physics.add.collider(this.player, this.meteorsY1, this.PlayerHitMeteors, null, this);
        this.meteorsY2 = new Meteors(
            this, this.meteorsY.x,
            this.meteorsY.y,
            'meteors', 6
        ).setScale(2.5);
        this.physics.add.collider(this.laserGroup, this.meteorsY2, this.laserHitMeteorsY2, null, this);
        this.physics.add.collider(this.player, this.meteorsY2, this.PlayerHitMeteors, null, this);
        meteorsY.destroy();
        laserGroup.destroy();
    }
///
    laserHitMeteorsY1(laserGroup, meteorsY1){
        ...
        this.physics.add.collider(this.laserGroup, this.meteorsY11, this.laserHitMeteorsY11, null, this);
        this.physics.add.collider(this.player, this.meteorsY11, this.PlayerHitMeteors, null, this);
        this.meteorsY12 = new Meteors(
            this, this.meteorsY1.x,
            this.meteorsY1.y,
            'meteors', 6
        ).setScale(1.25);
        this.physics.add.collider(this.laserGroup, this.meteorsY12, this.laserHitMeteorsY12, null, this);
        this.physics.add.collider(this.player, this.meteorsY12, this.PlayerHitMeteors, null, this);
        meteorsY1.destroy();
        laserGroup.destroy();
    }
    laserHitMeteorsY11(laserGroup, meteorsY11){
        ...
        this.physics.add.collider(this.laserGroup, this.meteorsY111, this.laserHitMeteorsY111, null, this);
        this.physics.add.collider(this.player, this.meteorsY111, this.PlayerHitMeteors, null, this);
        this.meteorsY112 = new Meteors(
            this, this.meteorsY11.x,
            this.meteorsY11.y,
            'meteors', 6
        ).setScale(0.75);
        this.physics.add.collider(this.laserGroup, this.meteorsY112, this.laserHitMeteorsY112, null, this);
        this.physics.add.collider(this.player, this.meteorsY112, this.PlayerHitMeteors, null, this);
        meteorsY11.destroy();
        laserGroup.destroy();
    }
    laserHitMeteorsY12(laserGroup, meteorsY12){
        ...
        this.physics.add.collider(this.laserGroup, this.meteorsY121, this.laserHitMeteorsY121, null, this);
        this.physics.add.collider(this.player, this.meteorsY121, this.PlayerHitMeteors, null, this);
        this.meteorsY122 = new Meteors(
            this, this.meteorsY12.x,
            this.meteorsY12.y,
            'meteors', 6
        ).setScale(0.75);
        this.physics.add.collider(this.laserGroup, this.meteorsY122, this.laserHitMeteorsY122, null, this);
        this.physics.add.collider(this.player, this.meteorsY122, this.PlayerHitMeteors, null, this);
        meteorsY12.destroy();
        laserGroup.destroy();       
    }
///   
    laserHitMeteorsY2(laserGroup, meteorsY2){
        ...
        this.physics.add.collider(this.laserGroup, this.meteorsY21, this.laserHitMeteorsY21, null, this);
        this.physics.add.collider(this.player, this.meteorsY21, this.PlayerHitMeteors, null, this);
        this.meteorsY22 = new Meteors(
            this, this.meteorsY2.x,
            this.meteorsY2.y,
            'meteors', 6
        ).setScale(1.25);
        this.physics.add.collider(this.laserGroup, this.meteorsY22, this.laserHitMeteorsY22, null, this);
        this.physics.add.collider(this.player, this.meteorsY22, this.PlayerHitMeteors, null, this);
        meteorsY2.destroy();
        laserGroup.destroy();
    }
    ...
    laserHitMeteorsY21(laserGroup, meteorsY21){
        ...
        this.physics.add.collider(this.laserGroup, this.meteorsY211, this.laserHitMeteorsY211, null, this);
        this.physics.add.collider(this.player, this.meteorsY211, this.PlayerHitMeteors, null, this);
        this.meteorsY212 = new Meteors(
            this, this.meteorsY21.x,
            this.meteorsY21.y,
            'meteors', 6
        ).setScale(0.75);
        this.physics.add.collider(this.laserGroup, this.meteorsY212, this.laserHitMeteorsY212, null, this);
        this.physics.add.collider(this.player, this.meteorsY212, this.PlayerHitMeteors, null, this);
        meteorsY21.destroy();
        laserGroup.destroy();
        }
    laserHitMeteorsY22(laserGroup, meteorsY22){
        ...
        this.physics.add.collider(this.laserGroup, this.meteorsY221, this.laserHitMeteorsY221, null, this);
        this.physics.add.collider(this.player, this.meteorsY221, this.PlayerHitMeteors, null, this);
        this.meteorsY222 = new Meteors(
            this, this.meteorsY22.x,
            this.meteorsY22.y,
            'meteors', 6
        ).setScale(0.75);
        this.physics.add.collider(this.laserGroup, this.meteorsY222, this.laserHitMeteorsY222, null, this);
        this.physics.add.collider(this.player, this.meteorsY222, this.PlayerHitMeteors, null, this);
        meteorsY22.destroy();
        laserGroup.destroy();
    }
    ...
    laserHitMeteorsX1(laserGroup, meteorsX1)
    {
            ...
            this.physics.add.collider(this.laserGroup, this.meteorsX11, this.laserHitMeteorsX11, null, this);
            this.physics.add.collider(this.player, this.meteorsX11, this.PlayerHitMeteors, null, this);
            this.meteorsX12 = new Meteors(
                this, this.meteorsX1.x,
                this.meteorsX1.y,
                'meteors', 6
            ).setScale(0.75);
            this.physics.add.collider(this.laserGroup, this.meteorsX12, this.laserHitMeteorsX12, null, this);
            this.physics.add.collider(this.player, this.meteorsX12, this.PlayerHitMeteors, null, this);
            meteorsX1.destroy();
            laserGroup.destroy(); 
    }
    laserHitMeteorsX2(laserGroup, meteorsX2)
    {
            ...
            this.physics.add.collider(this.laserGroup, this.meteorsX21, this.laserHitMeteorsX21, null, this);
            this.physics.add.collider(this.player, this.meteorsX21, this.PlayerHitMeteors, null, this);
            this.meteorsX22 = new Meteors(
                this, this.meteorsX2.x,
                this.meteorsX2.y,
                'meteors', 6
            ).setScale(0.75);
            this.physics.add.collider(this.laserGroup, this.meteorsX22, this.laserHitMeteorsX22, null, this);
            this.physics.add.collider(this.player, this.meteorsX22, this.PlayerHitMeteors, null, this);
            meteorsX2.destroy();
            laserGroup.destroy(); 
    }
    ...
    laserHitMeteorsX(laserGroup, meteorsX)
    {
            ...
            this.physics.add.collider(this.laserGroup, this.meteorsX1, this.laserHitMeteorsX1, null, this);
            this.physics.add.collider(this.player, this.meteorsX1, this.PlayerHitMeteors, null, this);
            this.meteorsX2 = new Meteors(
                this, this.meteorsX.x,
                this.meteorsX.y,
                'meteors', 6
            ).setScale(1.25);
            this.physics.add.collider(this.laserGroup, this.meteorsX2, this.laserHitMeteorsX2, null, this);
            this.physics.add.collider(this.player, this.meteorsX2, this.PlayerHitMeteors, null, this);
            meteorsX.destroy();
            laserGroup.destroy(); 
    }
